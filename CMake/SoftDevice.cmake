...
elseif (PLATFORM MATCHES "nrf51.*")
    set(SOFTDEVICE "s130_2.0.1" CACHE STRING "nRF51 SoftDevice")
    set_property(CACHE SOFTDEVICE PROPERTY STRINGS
        "s130_2.0.1" "s110_8.0.0")
elseif (PLATFORM MATCHES "nrf52832.*")
    set(SOFTDEVICE "s132_5.0.0" CACHE STRING "nRF52832 SoftDevice")
    set_property(CACHE SOFTDEVICE PROPERTY STRINGS
        "s132_3.1.0" "s132_4.0.4" "s132_5.0.0")
elseif (PLATFORM MATCHES "nrf52840.*")
    set(SOFTDEVICE "s140_5.0.0-3.alpha" CACHE STRING "nRF52840 SoftDevice")
    set_property(CACHE SOFTDEVICE PROPERTY STRINGS
        "s140_5.0.0-3.alpha")
endif ()
...
include("${CMAKE_CONFIG_DIR}/ExtractSoftDevice.cmake")
extract_softdevice(${SOFTDEVICE})
