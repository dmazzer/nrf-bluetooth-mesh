...
int uECC32_shared_secret(const uint32_t p_publicKey[uECC_BYTES*2/4], const uint32_t p_privateKey[uECC_BYTES/4], uint32_t p_secret[uECC_BYTES*2/4]);
...
int uECC32_compute_public_key(const uint32_t p_privateKey[uECC_BYTES/4], uint32_t p_publicKey[uECC_BYTES*2/4]);
