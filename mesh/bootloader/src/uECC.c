...
/*
arm-none-eabi-gcc -mthumb -mcpu=cortex-m0 -fshort-wchar -DuECC_ASM=uECC_asm_fast -DuECC_CURVE=uECC_secp256r1 -DuECC_SQUARE_FUNC=1 -O2 -c uECC.c -o uECC.m0.o
arm-none-eabi-gcc -mthumb -mcpu=cortex-m4 -fshort-wchar -DuECC_ASM=uECC_asm_fast -DuECC_CURVE=uECC_secp256r1 -DuECC_SQUARE_FUNC=1 -O2 -c uECC.c -o uECC.m4.o
*/
