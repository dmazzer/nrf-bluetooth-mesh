...
static cmpresult_t uECC_vli_cmp_unsafe(const uECC_word_t *left,
        ...
        uECC_PLATFORM == uECC_arm_thumb2) && !defined(__CC_ARM)
    /* FIXME: This file is not included for builds using the ARM compiler.
     *        The reason for this is that the ARM compiler, while being GCC
     *        compatible in many ways, does not support GCC's inline assembler
     *        syntax. Currently, compiling with the ARMCC compiler will result
     *        in the assembly optimizations being omitted.
     */
    #include "asm_arm.inc"
#endif
